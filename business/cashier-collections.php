...
require_page_access($conn, 'cashier-collections.php');

$pageTitle = 'Cashier Collections';
?>
<!DOCTYPE html>
...
<div class="page-head-card mb-3">
    <div>
        <h1 class="h4 fw-bold mb-1">Cashier Collections</h1>
        <p class="text-muted-custom mb-0 small">View cashier collection records.</p>
    </div>
</div>
