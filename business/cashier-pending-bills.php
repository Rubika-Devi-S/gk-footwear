...
require_page_access($conn, 'cashier-pending-bills.php');
...
<div class="page-head-card mb-3">
    <div>
        <h1 class="h4 fw-bold mb-1">Pending Bills</h1>
        <p class="text-muted-custom mb-0 small">Cashier can collect pending bill payment.</p>
    </div>
</div>
